...
## 1. データ準備
- [ ] 型定義 (`Lesson`, `LessonStatus` in `types/index.ts` 詳細はこちら: [./03_詳細設計/types/index.ts](./03_詳細設計/types/index.ts))
...
- [ ] データアクセス関数実装とテスト (`lib/lessonService.ts`, `lib/lessonService.test.ts` 詳細はこちら: [./03_詳細設計/lib/lessonService.ts.md](./03_詳細設計/lib/lessonService.ts.md))
...
- [ ] 実装 (`StatusBadge.tsx` 詳細はこちら: [./03_詳細設計/components/common/StatusBadge.tsx.md](./03_詳細設計/components/common/StatusBadge.tsx.md)): Propsに基づいたステータス表示 (テキスト・色)
...
- [ ] 実装 (`page.tsx` 詳細はこちら: [./03_詳細設計/app/schedule/today/page.tsx.md](./03_詳細設計/app/schedule/today/page.tsx.md)):
